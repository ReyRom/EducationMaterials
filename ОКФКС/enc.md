...
1. Что такое полиалфавитный шифр?
2. Как работает шифр Виженера?
3. В чем заключается метод Казиски?
4. Как частотный анализ помогает взломать шифр Виженера?
...
**Вопросы для закрепления материала:**  
1. Почему RSA считается безопасным?  
2. Для чего используется функция Эйлера в RSA?  
3. Чем RSA отличается от симметричных алгоритмов шифрования?  